...
class BaseCAM:
    ...
    def get_loss(self, output, target_category):
        ...
        return temp_output[target_category]
    ...
    def __call__(self, input_tensor, target_category=None):
        ...
        cam = np.interp(np.linspace(0, cam.shape[0], 300), np.linspace(0, cam.shape[0], cam.shape[0]), cam)   #Change it to the interpolation algorithm that numpy comes with.
